...
public class Tab3Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnTEST.setTextColor(Color.parseColor("#069edb"));
        ...
        text1 = (TextView) view.findViewById(R.id.textTab2);
        ...
        btnSHARE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check1 == ""){
                    ...
                    msg.putExtra(Intent.EXTRA_SUBJECT, "Thunderball Number");
                    msg.putExtra(Intent.EXTRA_TEXT, "India Lotto\n" + ctextR);
                    msg.putExtra(Intent.EXTRA_TITLE, "Thunderball Number");
                    msg.setType("text/plain");
                    startActivity(Intent.createChooser(msg, "Share"));
                    showGuide("Thunderball Number Share");
                }
            }
        });
    ...
    public void LotCOPY() {
        ...
        String tab_info1 = getString (R.string.tab_text3);
    ...
    public void GenNumber() {
        ...
        rednum1 = Rnum.lotArray(1,15);
        rednum2 = Rnum.lotArray(1,15);
        rednum3 = Rnum.lotArray(1,15);
        rednum4 = Rnum.lotArray(1,15);
        rednum5 = Rnum.lotArray(1,15);

        Lot1num1 = Rnum.lotArray(5,42);
        Lot1num2 = Rnum.lotArray(5,42);
        Lot1num3 = Rnum.lotArray(5,42);
        Lot1num4 = Rnum.lotArray(5,42);
        Lot1num5 = Rnum.lotArray(5,42);
