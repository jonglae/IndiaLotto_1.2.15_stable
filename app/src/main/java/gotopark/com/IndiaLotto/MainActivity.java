...
//TAP 맨위에 탭 아이콘  -->
        Objects.requireNonNull(tabLayout.getTabAt(0)).setIcon(R.drawable.menudot);
        Objects.requireNonNull(tabLayout.getTabAt(1)).setIcon(R.drawable.menudot);
        Objects.requireNonNull(tabLayout.getTabAt(2)).setIcon(R.drawable.menudot);
//TAP 맨위에 탭 아이콘  <---
