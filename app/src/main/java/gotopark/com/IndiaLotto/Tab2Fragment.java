...
public class Tab2Fragment extends Fragment {
    ...
    TextView F1TV1,F1TV2,F1TV3,F1TV4,F1TV5;
    TextView F2TV1,F2TV2,F2TV3,F2TV4,F2TV5;
    TextView F3TV1,F3TV2,F3TV3,F3TV4,F3TV5;
    TextView F4TV1,F4TV2,F4TV3,F4TV4,F4TV5;
    TextView F5TV1,F5TV2,F5TV3,F5TV4,F5TV5;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnSHARE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                msg.putExtra(Intent.EXTRA_SUBJECT, "Jaldi 5 Number");
                msg.putExtra(Intent.EXTRA_TEXT, "India Lotto\n" + ctextR);
                msg.putExtra(Intent.EXTRA_TITLE, "India Lottery");
                msg.setType("text/plain");
                startActivity(Intent.createChooser(msg, "Share"));
                showGuide("Jaldi 5 Number Share");
            }
            }
        });
